...
def login_and_submit_otjs(mfa_code: str) -> str:
    ...
    #method that will wait until a field is available
    ...
    # Enter mfa code that was passed as arg
    wait_for_element(By.ID, 'otp').send_keys(mfa_code + Keys.RETURN)
